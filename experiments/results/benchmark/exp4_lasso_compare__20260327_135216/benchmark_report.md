...
| Lasso-CV | 0.7195 | 0.0249 |

## 4. Performance Across SNR Levels

### 4.1 F1 by Sigma

|   sigma |   AFL-CV-1SE |   AdaptiveLasso-CV |   ElasticNet-1SE |   Lasso-CV |   RelaxedLasso-1SE |   UniLasso-CV |
|--------:|-------------:|-------------------:|-----------------:|-----------:|-------------------:|--------------:|
|     0.1 |       1      |             0.9244 |           0.7073 |     0.4108 |             0.7068 |        0.7632 |
|     0.5 |       0.9952 |             0.9146 |           0.7172 |     0.4327 |             0.7172 |        0.77   |
|     1   |       0.9751 |             0.8987 |           0.7166 |     0.438  |             0.7166 |        0.7803 |
|     1.5 |       0.9477 |             0.8834 |           0.7102 |     0.4338 |             0.7102 |        0.7728 |
|     2   |       0.9436 |             0.8649 |           0.7138 |     0.4343 |             0.7138 |        0.7465 |
|     3   |       0.9203 |             0.8099 |           0.7103 |     0.4414 |             0.7113 |        0.7305 |

### 4.2 MSE by Sigma

|   sigma |   AFL-CV-1SE |   AdaptiveLasso-CV |   ElasticNet-1SE |   Lasso-CV |   RelaxedLasso-1SE |   UniLasso-CV |
|--------:|-------------:|-------------------:|-----------------:|-----------:|-------------------:|--------------:|
|     0.1 |       0.5654 |            158.699 |           0.0164 |     0.015  |             0.0147 |        2.1986 |
|     0.5 |       0.8416 |            159.906 |           0.4117 |     0.3755 |             0.3691 |        2.2691 |
|     1   |       1.761  |            160.831 |           1.6402 |     1.5038 |             1.4774 |        2.8183 |
|     1.5 |       3.2874 |            162.086 |           3.6926 |     3.3826 |             3.3283 |        3.9935 |
|     2   |       5.5945 |            163.876 |           6.5725 |     6.0322 |             5.9325 |        5.7691 |
|     3   |      12.4297 |            169.116 |          14.741  |    13.5157 |            13.2063 |       11.3946 |
...
|     1.5 |        1     |              0.81  |                1 |          1 |                  1 |             1 |
|     2   |        1     |              0.782 |                1 |          1 |                  1 |             1 |
|     3   |        0.998 |              0.726 |                1 |          1 |                  1 |             1 |

### 4.4 FDR by Sigma

|   sigma |   AFL-CV-1SE |   AdaptiveLasso-CV |   ElasticNet-1SE |   Lasso-CV |   RelaxedLasso-1SE |   UniLasso-CV |
|--------:|-------------:|-------------------:|-----------------:|-----------:|-------------------:|--------------:|
|     0.1 |       0      |              0     |           0.4415 |     0.7376 |             0.4422 |        0.3732 |
|     0.5 |       0.0094 |              0     |           0.4292 |     0.7211 |             0.4292 |        0.3606 |
|     1   |       0.0462 |              0     |           0.4303 |     0.7139 |             0.4303 |        0.349  |
|     1.5 |       0.0944 |              0     |           0.439  |     0.7176 |             0.439  |        0.359  |
|     2   |       0.1026 |              0     |           0.4341 |     0.7158 |             0.4341 |        0.3926 |
|     3   |       0.139  |              0.002 |           0.4387 |     0.7108 |             0.4376 |        0.4146 |
...
| 0.1 | 10.0 | Lasso-CV | 0.4108 | 0.0150 | 1.0000 | 0.7376 | 0.2624 | 1.0000 | 0.9999 |
...
| 0.5 | 2.0 | Lasso-CV | 0.4327 | 0.3755 | 1.0000 | 0.7211 | 0.2789 | 1.0000 | 0.9978 |
...
| 1.0 | 1.0 | Lasso-CV | 0.4380 | 1.5038 | 1.0000 | 0.7139 | 0.2861 | 1.0000 | 0.9913 |
...
| 1.5 | 0.67 | Lasso-CV | 0.4338 | 3.3826 | 1.0000 | 0.7176 | 0.2824 | 1.0000 | 0.9806 |
...
| 2.0 | 0.5 | Lasso-CV | 0.4343 | 6.0322 | 1.0000 | 0.7158 | 0.2842 | 1.0000 | 0.9655 |
...
| 3.0 | 0.33 | Lasso-CV | 0.4414 | 13.5157 | 1.0000 | 0.7108 | 0.2892 | 1.0000 | 0.9244 |
...
- rank_6: Lasso-CV (F1=0.4318)

### 6.2 By MSE (lower is better)

- rank_1: RelaxedLasso-1SE (MSE=4.0547)
- rank_2: AFL-CV-1SE (MSE=4.0799)
- rank_3: Lasso-CV (MSE=4.1375)
- rank_4: ElasticNet-1SE (MSE=4.5124)
- rank_5: UniLasso-CV (MSE=4.7405)
- rank_6: AdaptiveLasso-CV (MSE=162.4190)
...
3. **SNR Sensitivity**:
   ...
   - Lasso-CV: F1 drop = -0.0161 (high SNR to low SNR)
...
---
*Report generated: 2026-03-27T14:41:28.087417*
