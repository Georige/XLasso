...
from unilasso_experiments.base_experiment import BaseSimulationExperiment, compute_variable_selection_metrics
from unilasso_experiments import visualization
...
class NonlinearExperiment(BaseSimulationExperiment):
    ...
    def evaluate_model(
        ...
        if hasattr(model, 'groups') and model.groups is not None:
            from unilasso_experiments.base_experiment import compute_group_accuracy
